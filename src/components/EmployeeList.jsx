          ...
          <tbody>
            {filteredEmployees.map((employee, index) => (
              <tr key={employee._id}>
                ...
                <td>
              <img
    src={employee.image ? `${import.meta.env.VITE_BE_URL}/${employee.image}` : 'https://via.placeholder.com/50'}
    alt="Employee"
  ...
  />
                ...
                <td>
                <Link to={`/edit-employee/${employee._id}`} className="btn btn-primary">
                    Edit
                  </Link>
                  <button
